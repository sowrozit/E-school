...
public class TopicController {
    ...
    public ModelAndView saveTopic(@Valid @ModelAttribute Topic topic, BindingResult result, ModelAndView model,@RequestParam CommonsMultipartFile file, HttpSession session)throws Exception{
        if(result.hasErrors()){
            List<Category> listCategory = categoryService.getAllCategories();
            model.addObject("listCategory", listCategory);
            model.setViewName("topicForm");
